<div class="container-fluid">
    <h1 class="display-5 py-5 text-center fw-bold">A Brief Look At Some Of My Projects</h1>
    <div class="row">
        <div class="col-sm-4">
            <div class="card">
                <div class="card-body">
        ...
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="https://github.com/NoahFlowa/WP_Lorem_Generator" class="btn btn-outline-primary">View GitHub Repo</a>
                </div>
            </div>
        </div>
    </div>
