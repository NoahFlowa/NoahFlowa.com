...
<body class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <!-- Jumbotron Import -->
            <?php require("jumbotron.php"); displayJumbotron("Howdy, Im NoahFlowa", "Welcome to my Website", "This serves as a hub for different information I want displayed in a single place.  Also serves as a pet project for myself!") ?>
            <!-- Active Games -->
            <?php require("activeGames.php"); ?>
            <!-- Footer -->
